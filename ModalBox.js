...
export default class ModalBox extends React.Component {
  ...
  onKeyboardChange = (evt) => {
    ...
    var keyboardHeight = this.state.keyboardOffset
  ...
  createPanResponder=() => {
    ...
    var onPanRelease = (evt, state) => {
      ...
      inSwipeArea = false
      if (this.props.entry === 'top' ? -state.dy > this.props.swipeThreshold : state.dy > this.props.swipeThreshold) { this.animateClose() } else if (!this.state.isOpen) {
        this.animateOpen()
      }
    }
